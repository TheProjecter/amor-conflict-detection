...
/**
 * This is the item provider adapter for a {@link org.modelversioning.conflictreport.conflict.Violation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViolationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Violation_severity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Violation_severity_feature", "_UI_Violation_type"),
				 ConflictPackage.Literals.VIOLATION__SEVERITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ViolationSeverity labelValue = ((Violation)object).getSeverity();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Violation.class)) {
			case ConflictPackage.VIOLATION__SEVERITY:
