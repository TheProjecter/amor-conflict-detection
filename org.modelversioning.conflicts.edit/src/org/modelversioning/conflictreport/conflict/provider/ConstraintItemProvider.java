...
/**
 * This is the item provider adapter for a {@link org.modelversioning.conflictreport.conflict.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_oclExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_oclExpression_feature", "_UI_Constraint_type"),
				 ConflictPackage.Literals.CONSTRAINT__OCL_EXPRESSION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Constraint)object).getOclExpression();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constraint.class)) {
			case ConflictPackage.CONSTRAINT__OCL_EXPRESSION:
